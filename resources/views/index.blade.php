...
<head>
    ...
    <style>
        ...
        * {
        ...
        #block-new18 input.input::-webkit-input-placeholder {
            font-family: 'pt sans' !important;
        }

        #block-new18 input.input::-moz-placeholder {
            font-family: 'pt sans' !important;
        }
        ...
        #block-new18 input.input:-ms-input-placeholder {
            font-family: 'pt sans' !important;
        }
    </style>
        ...
        <table>
            ...
            <tr>
                ...
                <td style="vertical-align:top;">
                    <div id="lpg__oldBrowserWarning__closeX" class="lpg__oldBrowserWarning__ico_closeX"></div>
                </td>
            </tr>
            </tbody>
        </table>
...
<div class="container preview-main-container" style="">
    ...
    <div id="preview" class="page_container" style="margin: 0 auto; position: relative; ">
        ...
        <div class="block block-form is-form" id="block-new18"
            ...
            <form action="http://www.lux-ticket.com/var/1207080/form/action/?d=www.lux-ticket.com" method="post"
                ...
                <div class="step step-0" data-button="" style="display: block">
                    <div class="cont " data-name="widget_0" data-first_name="1" data-ordering="0" data-default=""
                         data-label="ИМЯ" data-type="input"><input type="text" class="input" name="widget_0" value=""
                                                                   placeholder="ИМЯ"></div>
                    <div class="cont " data-name="widget_1" data-ordering="1" data-default="" data-label="ПОЧТА"
                         data-type="email" data-email="1"><input type="email" class="input" name="widget_1" value=""
                                                                 placeholder="ПОЧТА"></div>
                    <div class="cont " data-name="widget_2" data-default="" data-pattern="" data-required="1"
                         data-mask="" data-phone="1" data-ordering="2" data-label="ТЕЛЕФОН" data-type="tel"><input
                                type="tel" class="input" name="widget_2" value="" required="" placeholder="ТЕЛЕФОН*">
                    </div>
                </div>
                <input type="hidden" name="csrfmiddlewaretoken" value="j3l8ZrFwezab0xH97N00UsT21GN3bvns"></form>
            <div class="message" style="display: none;"><a class="redirect" href="http://lux-ticket.com/thankyou/"></a>
            </div>
        </div>


        <style id="block-style-new19"> #block-new19 {
                display: block;
                position: absolute;
                background-position: 0% 0%;
                background-repeat: no-repeat;
                ...
                color: #ffffff;
                top: 723px;
                raw-css: font-family: pt sans;
                text-transform: uppercase;;
                height: 35px;
                width: 195px;
                z-index: 116;
                anchor-id: #block-new19;
                font-weight: bold;
        ...
        <div class="block block-button is-submit" id="block-new19">
            <a href="http://www.lux-ticket.com/#fire_form_new18" target="" data-label="заказать консультацию">заказать сетку</a>
        ...
        <style id="block-style-new25"> #block-new25 {
                display: block;
                position: absolute;
                background-position: 0% 0%;
                background-repeat: no-repeat;
        ...
        <style id="block-style-new24"> #block-new24 {
                display: block;
                position: absolute;
                background-position: 0% 0%;
                background-repeat: no-repeat;
...
для вашего сада</span></span></span></strong></p>
        ...
        <style id="block-style-new21"> #block-new21 {
                display: block;
                position: absolute;
                background-position: 0% 0%;
                background-repeat: no-repeat;
        ...
        <div class="block block-image is-image" id="block-new21">
            ...
            <img src="./index_files/shadow-kopiya.png" alt="" width="215" height="59">
        ...
        <style id="block-style-new5"> #block-new5 {
                display: block;
                position: absolute;
                background-position: 0% 0%;
                background-repeat: no-repeat;
...
{{--<div class="jivo-iframe-container-bottom jivo-state-widget jivo-collapsed jivo_shadow jivo_rounded_corners jivo_gradient"
    ...
    <iframe src="javascript:false" title="" name="jivo_container" id="jivo_container" frameborder="no"
            style="width: 100%; height: 100%; border: 0px;" src="./index_files/saved_resource.html"></iframe>
    <style type="text/css">div#jivo-iframe-container * {
            max-height: 100%
        }
        ...
        body.jivo-mobile-widget.jivo-mobile-overlay:after {
            content: "";
            display: block;
            position: fixed;
            top: 0;
        ...
        div#jivo-iframe-container #jivo-action-container {
        ...
        div#jivo-iframe-container.jivo-c-mobile.jivo-c-mobile-absolute {
            position: absolute !important
        }

        div#jivo-iframe-container.jivo-c-mobile.jivo-c-mobile-absolute.jivo-no-transition.jivo-transition-opacity {
            -webkit-transition: opacity .3s cubic-bezier(.39, .24, .21, .99) !important;
            transition: opacity .3s cubic-bezier(.39, .24, .21, .99) !important
        }

        div#jivo-iframe-container.jivo-custom-label {
            transition: none !important
        }

        div#jivo-iframe-container.jivo-custom-label.jivo-state-widget {
            display: none !important
        }

        div#jivo-iframe-container.jivo-separate-window {
            bottom: 0 !important;
            top: 0 !important;
            right: 0 !important;
            left: 0 !important;
        ...
        div#jivo-iframe-container.jivo_shadow.jivo-opening div#jivo-iframe-container.jivo_shadow:after {
            height: 100% !important
        }

        div#jivo-iframe-container.jivo_shadow.jivo-state-widget div#jivo-iframe-container.jivo_shadow.jivo-iframe-container-bottom:after, div#jivo-iframe-container.jivo_shadow.jivo-state-widget div#jivo-iframe-container.jivo_shadow.jivo-iframe-container-top:after {
            height: 38px
        }
        ...
        div#jivo-iframe-container.jivo-expanded:after {
            background: transparent;
            position: absolute !important;
            width: 100% !important;
            bottom: 0 !important;
        ...
        div#jivo-iframe-container iframe body {
            overflow: hidden
        }

        div#jivo-iframe-container.jivo-ie8 {
        ...
        div#jivo-iframe-container.jivo-ie8:after {
            display: none;
            border-width: 0
        }
        ...
        div#jivo-iframe-container.jivo-iframe-container-bottom.jivo_shadow.jivo-expanded:after, div#jivo-iframe-container.jivo-iframe-container-bottom.jivo_shadow.jivo-state-widget:after {
            height: 38px;
        ...
        div#jivo-iframe-container.jivo-iframe-container-bottom.jivo_shadow:after {
            height: 100%;
            -webkit-box-shadow: 0 12px 25px 8px rgba(0, 0, 0, 0.17);
            -moz-box-shadow: 0 12px 25px 8px rgba(0, 0, 0, 0.17);
            box-shadow: 0 12px 25px 8px rgba(0, 0, 0, 0.17)
        ...
        div#jivo-iframe-container.jivo-iframe-container-bottom.jivo-ie8 {
            min-width: 0 !important;
            width: 300px
        }

        div#jivo-iframe-container.jivo-iframe-container-bottom.jivo-ie8.jivo-state-widget-expanded {
            border-top-width: 0;
            border-left-width: 0;
        ...
        div#jivo-iframe-container.jivo-iframe-container-bottom.jivo-wp {
        ...
        div#jivo-iframe-container.jivo-iframe-container-left.jivo-collapsed {
            min-height: 124px
        }

        div#jivo-iframe-container.jivo-iframe-container-left.jivo-state-widget {
            border-radius: 0 30px 3px 0 !important
        }

        div#jivo-iframe-container.jivo-iframe-container-left.jivo_shadow.jivo-state-widget:after {
            width: 38px;
            height: 100%
        }

        div#jivo-iframe-container.jivo-iframe-container-left.jivo_shadow.jivo-expanded:after {
            width: 100%
        }

        div#jivo-iframe-container.jivo-iframe-container-left.jivo_shadow.jivo-collapsed:after {
            width: 38px;
            height: 100%
        }

        div#jivo-iframe-container.jivo-iframe-container-left.jivo_shadow:after {
            border-radius: 0 30px 3px 0 !important;
            right: auto !important;
            left: 0 !important;
            -webkit-box-shadow: 0 12px 25px 8px rgba(0, 0, 0, 0.17);
        ...
        div#jivo-iframe-container.jivo-iframe-container-left.jivo_shadow.jivo-opening:after, div#jivo-iframe-container.jivo-iframe-container-left.jivo_shadow.jivo-closing:after {
            -webkit-box-shadow: none !important;
            -moz-box-shadow: none !important;
            box-shadow: none !important
        }

        div#jivo-iframe-container.jivo-iframe-container-left.jivo-expanded {
            left: 0
        }
        ...
        div#jivo-iframe-container.jivo-iframe-container-right.jivo-collapsed {
            min-height: 124px
        }
        ...
        div#jivo-iframe-container.jivo-iframe-container-right.jivo_shadow.jivo-expanded:after {
            border-radius: 3px 30px 0 3px !important;
            width: 100%;
            visibility: visible
        }

        div#jivo-iframe-container.jivo-iframe-container-right.jivo_shadow:after {
            top: 1px;
            border-radius: 30px 0 0 3px !important;
        ...
        div#jivo-iframe-container.jivo-iframe-container-right.jivo-opening:after, div#jivo-iframe-container.jivo-iframe-container-right.jivo-closing:after {
            -webkit-box-shadow: none !important;
            -moz-box-shadow: none !important;
            box-shadow: none !important
        }

        div#jivo-iframe-container.jivo-iframe-container-right.jivo-expanded {
            right: 0
        }

        div#jivo-iframe-container.jivo-iframe-container-top {
            right: 30px;
            min-width: 300px !important
        }

        div#jivo-iframe-container.jivo-iframe-container-top.jivo-cbenabled {
            min-width: 300px !important
        }

        div#jivo-iframe-container.jivo-iframe-container-top.jivo_shadow.jivo-expanded:after {
            border-radius: 0 30px 3px 0 !important
        }

        div#jivo-iframe-container.jivo-iframe-container-top.jivo_shadow.jivo-opening:after {
            border-radius: 3px 30px 0 0 !important
        }

        div#jivo-iframe-container.jivo-iframe-container-top.jivo_shadow.jivo-closing:after {
            border-radius: 0 0 3px 30px !important
        }

        div#jivo-iframe-container.jivo-iframe-container-top.jivo_shadow:after {
            top: 0 !important;
            border-radius: 0 0 3px 30px !important;
            -webkit-box-shadow: 0 12px 25px 8px rgba(0, 0, 0, 0.17);
            -moz-box-shadow: 0 12px 25px 8px rgba(0, 0, 0, 0.17);
        ...
        div#jivo-iframe-container.jivo-iframe-container-top.jivo-expanded {
            top: 0
        }

        div#jivo-iframe-container.jivo-iframe-container-topdiv.jivo-resizing {
            top: auto
        }
        ...
        div#jivo_close_button.jivo-tablet {
            width: 34px !important;
            height: 34px !important
        }

        div#jivo_close_button.jivo-tablet svg {
            width: 34px !important;
            height: 34px !important;
            left: -10px !important;
            max-height: initial
    ...
    <div id="jivo-action-container">
        <div dir="ltr" id="jivo_action" style="display: none; height: 70px;">
            <div id="jivo_close_button" class="">
